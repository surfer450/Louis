...
class MessageBroker:
    ...
    @staticmethod
    def bind_queue(exchange_name: str, queue_name: str, routing_key: Optional[str] = None) -> None:
        """
    ...
    @staticmethod
    def publish(exchange_name: str, message: Any, routing_key: Optional[str] = None) -> None:
        """
    ...
    @staticmethod
    def read_message(queue_name: str) -> Any:
